...
import { createPriceEntry } from '../../firebase/firestore';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createPriceEntry({
        ...
        groceryBrandName: groceryBrandName.trim(),
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setGroceryBrandName(e.target.value)}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                value={country}
                onChange={(e) => setCountry(e.target.value as 'SE' | 'DK')}
                className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-gray-100"
              >
